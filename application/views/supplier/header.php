                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="<?= base_url('asset/AdminLTE/') ?>dist/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item ">
                                    <a href="<?= base_url('supplier/c_pemesanansupplier/pemesanan_masuk') ?>" class="nav-link <?php if ($this->uri->segment(1) == 'supplier' && $this->uri->segment(2) == 'c_pemesanansupplier' && $this->uri->segment(3) == 'pemesanan_masuk') {
                                                                                                                                    echo 'active';
                                                                                                                                }  ?>">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('supplier/c_pemesanansupplier/harga_barang') ?>" class="nav-link <?php if ($this->uri->segment(1) == 'supplier' && $this->uri->segment(2) == 'c_pemesanansupplier' && $this->uri->segment(3) == 'harga_barang') {
                                                                                                                                echo 'active';
                                                                                                                            }  ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Harga Barang</p>
